...
The next sections describe the multiple steps in \emph{Model Judge}'s algorithm
...
The second step in \emph{Model Judge}'s analysis of process models is extracting
